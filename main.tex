...
\label{table:leaderboard_hotpotqa} % For referencing the table in the text
\end{table*}
...
\begin{figure}[t] % 'h' for "here", can be replaced with other placement specifiers
  \centering
  \includegraphics[width=\linewidth]{fig/fig_general_pipeline2.png} % Adjust 'width' as needed
  ...
  \label{fig:general_pipeline} % For referencing the figure in the text
\end{figure}

...
\begin{figure*}[ht]
 ...
 \begin{tabular} { | l | l | c | c | c | c | c | c | }
  ...
  \hline
  \multirow{2}{*}{\multicolumn{2}{|c|}{Model2}} & \multicolumn{2}{|c|}{Ans} & \multicolumn{2}{|c|}{Sup} & \multicolumn{2}{|c|}{Joint} \\
  & & EM & F1 & EM & F1 & EM & F1 \\
  \hline
  1 & Beam Retriever \cite{RN105} & 72.69 & 85.04 & 66.25 & 90.09 & 50.53 & 77.54 \\

...
The advancement of multi-hop QA has been greatly facilitated by the introduction of specific datasets designed to test and refine the reasoning capabilities of AI models as displayed below in Table 1. 
...
% Scalability (handling large documents)
% Generalizability (good performance across various domains)
% Robustness (resistance to noisy data)

\subsection{Future Directions}
% Integration with other AI techniques (Reinforcement learning, hybrid model with other neural network architectures)
% Advancements in GNN architectures (novel aggregation and combination techniques, enhance dynamic graphs)
